...
def banner():
	print '''  _______  __   __  _______  _______    __   __  _______  _______  __   __  __   __  ___  
|   _   ||  | |  ||   _   ||       |  |  | |  ||   _   ||       ||  | |  ||  |_|  ||   | 
|  |_|  ||  |_|  ||  |_|  ||____   |  |  |_|  ||  |_|  ||  _____||  |_|  ||       ||   | 
|       ||       ||       | ____|  |  |       ||       || |_____ |       ||       ||   | 
|       ||_     _||       || ______|  |       ||       ||_____  ||       ||       ||   | 
|   _   |  |   |  |   _   || |_____   |   _   ||   _   | _____| ||   _   || ||_|| ||   | 
|__| |__|  |___|  |__| |__||_______|  |__| |__||__| |__||_______||__| |__||_|   |_||___| 

                               %s				
'''%(pyc.cLine('YELLOW', "SPADE moded bY : Ayaz Hashmi(Dr #ASH)"))
